 ...
 *   $attributes - associative array: display-name => value.
...
$show_analytics = variable_get('devconnect_show_analytics', FALSE);
?>
...
<?php foreach ($app_attributes as $label => $value): ?>
    <?php // TODO: generate attributes labels/values here ?>
<?php endforeach; ?>
  ...
  <div class="tab-pane" id="details">
    <h3>App Details</h3>
    <div class="well">
    <?php //print drupal_render(drupal_get_form('devconnect_developer_apps_edit_form', $account, $name)); ?>
...
<?php if ($show_analytics): ?>
  <div class="tab-pane" id="performance">
    <?php if (empty($analytics_chart)): ?>
      <p>
        Performance data is not available.<br>
        Have you enabled an <a href="#">OAuth Policy</a>?
      </p>
    <?php else: ?>
